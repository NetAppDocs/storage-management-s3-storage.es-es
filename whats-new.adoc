...
summary: Descubra las novedades sobre el almacenamiento de Amazon S3 en la consola de NetApp . 
---
= Novedades del almacenamiento de Amazon S3 en la consola de NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Descubra las novedades sobre el almacenamiento de Amazon S3 en la consola de NetApp .
